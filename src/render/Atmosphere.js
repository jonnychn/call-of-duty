...
export const TIME_OF_DAY = {
  ...
  dawn: {
    ...
    skyExposure: 0.55, sunDiscIntensity: 0.55, aureole: 0.55,
    starIntensity: 0.22, groundColor: 0x14161c,
    sunIntensity: 3.9, sunColor: 0xffa661,
    ambient: 0.26, hemiSky: 0x6d8dbd, hemiGround: 0x1a140e, hemiIntensity: 0.38,
    bounceColor: 0x44577a, bounceIntensity: 0.38,
    ...
    lift: [0.012, 0.018, 0.032], gain: [1.02, 0.99, 1.02],
    hazeColor: 0x8d7f92, hazeStrength: 0.72, cloudHeight: 1400,
    cloudCoverage: 0.65, cloudDensity: 0.95, cloudScale: 0.50, cloudHigh: 0.55,
  ...
  morning: {
    elevation: 33, azimuth: 122,
    turbidity: 2.6, rayleigh: 1.7, mieCoefficient: 0.0035, mieG: 0.78,
    skyExposure: 0.80, sunDiscIntensity: 0.9, aureole: 0.22,
    starIntensity: 0.0, groundColor: 0x2a2721,
    sunIntensity: 8.6, sunColor: 0xfff0d6,
    ambient: 0.38, hemiSky: 0xb0c8e8, hemiGround: 0x2e281f, hemiIntensity: 0.36,
    bounceColor: 0x7b7364, bounceIntensity: 0.30,
    ...
    lift: [0.008, 0.011, 0.020], gain: [1.01, 1.0, 1.0],
    hazeColor: 0xaebdca, hazeStrength: 0.44, cloudHeight: 2100,
    cloudCoverage: 0.47, cloudDensity: 0.87, cloudScale: 0.60, cloudHigh: 0.32,
  ...
  noon: {
    ...
    skyExposure: 0.88, sunDiscIntensity: 1.0, aureole: 0.18,
    starIntensity: 0.0, groundColor: 0x35312a,
    sunIntensity: 9.8, sunColor: 0xfff6ea,
    ambient: 0.46, hemiSky: 0xbcd0ea, hemiGround: 0x383025, hemiIntensity: 0.42,
    bounceColor: 0x8a8070, bounceIntensity: 0.34,
    ...
    lift: [0.009, 0.011, 0.016], gain: [1.0, 1.0, 1.0],
    hazeColor: 0xb8c4cf, hazeStrength: 0.38, cloudHeight: 2300,
    cloudCoverage: 0.41, cloudDensity: 0.80, cloudScale: 0.66, cloudHigh: 0.22,
  ...
  afternoon: {
    elevation: 36, azimuth: 246,
    turbidity: 5.5, rayleigh: 2.1, mieCoefficient: 0.011, mieG: 0.86,
    skyExposure: 0.76, sunDiscIntensity: 1.0, aureole: 0.45,
    starIntensity: 0.0, groundColor: 0x2b241a,
    sunIntensity: 8.2, sunColor: 0xffdcab,
    ambient: 0.32, hemiSky: 0x9ab6de, hemiGround: 0x352a1c, hemiIntensity: 0.42,
    bounceColor: 0x9a7c56, bounceIntensity: 0.40,
    ...
    lift: [0.010, 0.014, 0.026], gain: [1.03, 1.0, 0.96],
    hazeColor: 0xb59a7e, hazeStrength: 0.58, cloudHeight: 1800,
    cloudCoverage: 0.57, cloudDensity: 0.97, cloudScale: 0.52, cloudHigh: 0.46,
  ...
  dusk: {
    ...
    skyExposure: 0.68, sunDiscIntensity: 0.7, aureole: 0.85,
    starIntensity: 0.10, groundColor: 0x18140f,
    sunIntensity: 3.6, sunColor: 0xff7a3c,
    ambient: 0.22, hemiSky: 0x5a70a4, hemiGround: 0x150e09, hemiIntensity: 0.34,
    bounceColor: 0x7d4a2c, bounceIntensity: 0.38,
    ...
    lift: [0.010, 0.015, 0.032], gain: [1.05, 0.99, 0.95],
    hazeColor: 0xb06a42, hazeStrength: 0.78, cloudHeight: 1500,
    cloudCoverage: 0.69, cloudDensity: 0.98, cloudScale: 0.46, cloudHigh: 0.62,
  ...
  night: {
    ...
    sunIntensity: 1.5, sunColor: 0x9fb8e8,
    ambient: 0.19, hemiSky: 0x35476e, hemiGround: 0x070a10, hemiIntensity: 0.26,
    bounceColor: 0x222c44, bounceIntensity: 0.22,
    ...
    lift: [0.006, 0.012, 0.026], gain: [0.94, 0.98, 1.10],
    hazeColor: 0x1c2740, hazeStrength: 0.50, cloudHeight: 1700,
    cloudCoverage: 0.49, cloudDensity: 0.77, cloudScale: 0.55, cloudHigh: 0.28,
...
export class Atmosphere {
  ...
  apply(preset) {
    ...
    u.hazeColor.value.setHex(p.hazeColor ?? p.fogHorizon ?? 0xb9c3cf);
    u.hazeStrength.value = p.hazeStrength ?? 0.5;
    u.cloudHeight.value = p.cloudHeight ?? 1900;
    u.cirrusHeight.value = p.cirrusHeight ?? 7200;
